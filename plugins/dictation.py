...
def handle(cmd, core):
    if ("notes" in cmd or "note" in cmd) and "stop" not in cmd:
        ...
        while True:
            ...
            if any(x in text for x in ["stop notes", "stop note", "end notes", "exit notes", 
                                        "stop nurts", "stop nots", "stop nuts", "stopnotes",
                                        "done notes", "finish notes", "close notes", "closed notes"]):
                core.speak("Done")
                return True
