...
# The benchmark doesn't exercise the wake-word path, so stub pyopen_wakeword
# before tests import easyspeak.core.main. Same pattern as tests/unit/core/conftest.py.
